  ...
  Future<void> _loadSettings() async {
    ...
    if (mounted) {
      setState(() {
        ...
        _showProfilePhoto = prefs.getBool('privacy_show_profile_photo') ?? true;
        ...
        children: [
          ...
          _buildCardSection(
            ...
            trailing: Icon(
              ...
              color: Colors.grey[400],
              size: 20,
            ), // Placeholder to match original design
          ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.phone), onPressed: _callSupport),
