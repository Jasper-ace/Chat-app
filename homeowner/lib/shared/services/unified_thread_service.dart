...
class UnifiedThreadService {
  ...
  Future<String> getOrCreateThread({
    ...
    print(
      '🔍 HOMEOWNER: getOrCreateThread called with tradieId=$tradieId, homeownerId=$homeownerId',
    );
    ...
    return await _firestore.runTransaction<String>((transaction) async {
      ...
      for (int i = 0; i < allResults.length; i++) {
        ...
        if (allResults[i].docs.isNotEmpty) {
          ...
          print(
            '✅ HOMEOWNER: Found existing thread (combo ${i + 1}): $threadDocName',
          );
      ...
      print(
        '📝 HOMEOWNER: No existing thread found via queries, checking all threads...',
      );
      ...
      print('📝 HOMEOWNER: No matching thread found, creating new one...');
      ...
      print('📝 HOMEOWNER: Creating thread: $threadDocName (ID: $nextId)');
      ...
      print('✅ HOMEOWNER: Thread created successfully: $threadDocName');
      return threadDocName;
    });
  }
