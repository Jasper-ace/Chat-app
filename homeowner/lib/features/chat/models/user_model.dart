...
class UserModel {
  ...
  final int? autoId; // Auto-increment ID for thread system
  final String name;
  final String email;
  ...
  factory UserModel.fromFirestore(DocumentSnapshot doc) {
    ...
    return UserModel(
      id: doc.id,
      autoId: data['id'] as int?, // Auto-increment ID from document
      name: data['name'] ?? '',
      email: data['email'] ?? '',
      ...
      additionalData: Map<String, dynamic>.from(data)
        ..removeWhere(
          (key, value) => [
            'id', // Remove auto-increment ID from additional data
            'name',
            'email',
            'userType',
            'tradeType',
  ...
  Map<String, dynamic> toFirestore() {
    ...
    if (autoId != null) {
      data['id'] = autoId; // Include auto-increment ID
    }
