...
class _ChatScreenState extends ConsumerState<ChatScreen> {
  ...
  Future<void> _checkBlockedStatus() async {
    ...
    print('   My ID: $_currentUserId (homeowner)');
  ...
  Future<void> _sendMessageInBackground(
    ...
    try {
      ...
      // For new chats, just send the message - backend will find or create thread
      bool isNewChat =
      ...
      // Send message - backend handles thread creation and returns thread_id
      ...
      if (threadId != null && isNewChat && mounted) {
  ...
  void _updateTypingStatus(bool isTyping) {
    ...
    final typingPath = 'threads/$chatId/typing/${_currentUserId}_homeowner';
