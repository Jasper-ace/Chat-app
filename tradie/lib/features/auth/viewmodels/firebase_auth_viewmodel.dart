...
import '../services/tradie_api_auth_service.dart';
...
class FirebaseAuthViewModel extends StateNotifier<FirebaseAuthState> {
  final TradieApiAuthService _authService;
...
// Providers
final tradieAuthServiceProvider = Provider<TradieApiAuthService>((ref) {
  return TradieApiAuthService();
});
